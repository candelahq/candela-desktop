...
@Deprecated(
  'Use catalog RPC pricing (catalogProvider / ModelCatalogEntry) '
...
const Map<String, ModelPricing> _pricingMap = {
  ...
  'deepseek-r1-0528-maas': ModelPricing(
    inputPerMillion: 0.14,
    outputPerMillion: 0.28,
  ),
  'deepseek-r1': ModelPricing(inputPerMillion: 0.14, outputPerMillion: 0.28),
  'deepseek-v3.2-maas': ModelPricing(
    inputPerMillion: 0.14,
    outputPerMillion: 0.28,
  ),
  'deepseek-v3-maas': ModelPricing(
    inputPerMillion: 0.14,
    outputPerMillion: 0.28,
  ),
  ...
  // ── Qwen (via Vertex AI) ───────────────────────────────────────
  'qwen3-235b-a22b-instruct-2507-maas': ModelPricing(
    inputPerMillion: 0.30,
    outputPerMillion: 1.20,
  ),
  'qwen3-coder-480b-a35b-instruct-maas': ModelPricing(
    inputPerMillion: 0.22,
    outputPerMillion: 1.80,
  ),
  'qwen-2.5-coder-32b-instruct-maas': ModelPricing(
    inputPerMillion: 0.30,
    outputPerMillion: 1.20,
  ),
};
...
@Deprecated(
  'Pricing should come from the catalog RPC (ModelCatalogService). '
