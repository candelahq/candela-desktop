        ...
        children: [
          ...
          Expanded(
            child: TabBarView(
              ...
              children: const [_CatalogTab(), _UsageTab()],
            ),
          ),
        ],
      ),
...
class _CatalogTabState extends ConsumerState<_CatalogTab>
  ...
  Widget build(BuildContext context) {
    ...
    final viewModels = catalogState.models
        .map(CatalogModelView.fromTeamEntry)
        .toList();
      ...
      return const Center(
        child: Column(
          ...
          children: [
            ...
            SizedBox(height: 8),
            Text(
              'The model catalog will populate once the backend is configured.',
              style: TextStyle(
                fontSize: 13,
                color: CandelaColors.textSecondary,
              ),
        ...
        Expanded(
          child: Row(
            children: [
              ...
              if (selected != null)
                Expanded(flex: 2, child: _CatalogDetail(model: selected)),
            ],
          ),
        ),
      ],
  ...
  Future<void> _fetch() async {
    ...
    try {
      ...
      setState(() {
        ...
        final unusedModels = availableIds
            .where((id) => !usedNames.contains(id))
            .map((id) {
              ...
              return ModelBreakdown(
                ...
                outputPricePerMillion:
                    entry != null && entry.outputPerMillion > 0
                    ? entry.outputPerMillion
                    : null,
              );
            })
            ...
            child: AnimatedContainer(
              ...
              child: Text(
                ...
                style: TextStyle(
                  ...
                  color: active ? Colors.white : CandelaColors.textMuted,
                ),
              ),
            ),
          );
          ...
          for (final f in _ModelFilter.values)
            GestureDetector(
              ...
              child: AnimatedContainer(
                ...
                child: Text(
                  f == _ModelFilter.all ? 'All Available' : 'Used',
                  style: TextStyle(
                    fontSize: 12,
    ...
    return const Center(
      child: Column(
        ...
        children: [
          ...
          SizedBox(height: 8),
          Text(
            'Model data appears once LLM calls flow through the proxy.',
          ...
          child: ListView.builder(
            ...
            itemBuilder: (_, i) {
              ...
              return _UsageRow(
                ...
                maxCost: _maxCost,
                onTap: () => setState(() {
                  _selectedModel = display[i].model == _selectedModel
                      ? null
                      : display[i].model;
                }),
              );
      ...
      child: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            ...
            _statTile(
              'Input Tokens',
              _fmtTokens(model.inputTokens),
              Icons.arrow_forward,
              const Color(0xFF60A5FA),
            ),
            _statTile(
              'Output Tokens',
              _fmtTokens(model.outputTokens),
              Icons.arrow_back,
                ...
                builder: (_) {
                  ...
                  return Column(
                    ...
                    children: [
                      ...
                      _metricBar(
                        'Cache Read',
                        _fmtTokens(model.cacheReadTokens),
                      ),
                    ],
                  );
                },
